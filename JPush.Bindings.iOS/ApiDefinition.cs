...
namespace JPush.Bindings.iOS
{
	...
	*/
	...
	public interface JPUSHRegisterEntity
	{
	...
	[BaseType(typeof(NSObject))]
	public interface JPushNotificationIdentifier : INSCopying, INSCoding
	{
	...
	[BaseType(typeof(NSObject))]
	public interface JPushNotificationContent : INSCopying, INSCoding
	{
	...
	[BaseType(typeof(NSObject))]
	public interface JPushNotificationTrigger : INSCopying, INSCoding
	{
	...
	[BaseType(typeof(NSObject))]
	public interface JPushNotificationRequest : INSCopying, INSCoding
	{
	...
	[Protocol, Model]
	[BaseType(typeof(NSObject))]
	public interface JPUSHRegisterDelegate
	{
